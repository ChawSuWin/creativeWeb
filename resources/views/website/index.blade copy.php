...
<body>
	...
	<div id="preloader">
		<div id="loading">
			<img width="256" height="32" src="{{url('website/assets/img/loading-cylon-red.svg')}}">
		</div>
	</div>
	<!-- =============== nav =============== -->
		...
		<div class="container">
			<div class="container-fluid">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="#"><img src="{{url('website/assets/img/logo1.png')}}" alt="Logo">
					</a>
				</div>
				...
				<div id="owl-demo" class="owl-carousel header1">
					<div>
						<div class="col-xs-12 col-sm-6 col-md-6 header-text">
							<h2 class="wow bounceIn animated" data-wow-delay=".40s">FRIENDLY <span>TEMPLATE</span> FOR
								<br />YOUR WEBSITE</h2>
							<h3 class="wow bounceIn animated" data-wow-delay=".50s">FOR YOUR WEBSITE </h3>
							<p class="wow bounceIn animated" data-wow-delay=".60s">Lorem ipsum dolor sit amet,
								consectetur adipiscing elit.We ensure sit amet, consectetur adipiscing elit</p>
							<p>
								<div class="btn btn-primary btn-lg btn-ornge wow bounceIn animated" data-wow-delay="1s">
									<i class="hbtn"></i> <span>Click Here</span></i>
								</div>
							</p>
						</div>
					</div>
					<div>
						<div class="col-xs-12 col-sm-6 col-md-6 header-text">
							<h2 class="wow bounceIn animated" data-wow-delay=".40s">FRIENDLY <span>THIS</span> FOR
								<br />YOUR WEBSITE</h2>
							<h3 class="wow bounceIn animated" data-wow-delay=".50s">FOR YOUR WEBSITE </h3>
							<p class="wow bounceIn animated" data-wow-delay=".60s">Lorem ipsum dolor sit amet,
								consectetur adipiscing elit.We ensure sit amet, consectetur adipiscing elit</p>
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-6 wow fadeInLeft animated" data-wow-delay=".5s">
					<img src="{{url('website/assets/img/services-img.jpg')}}" class="img-left" />
				</div>
				<div class="col-xs-12 col-sm-12 col-md-6 wow fadeInRight animated" data-wow-delay=".5s">
					<h2>Services</h2>
					<p>Lorem ipsum dolor sit amet, netus pellentesque mauris, non quis adipiscing aliquam tortor nulla,
	...
	<section id="Gallery" class="wow flipInX animated" data-wow-delay=".5s">
		<div class="title">
			<h2>Gallery</h2>
			<p class='message'>We are awesome, check some interesting facts.</p>
		</div>
		...
		<div class="big-demo go-wide" data-js-module="filtering-demo">
			...
			<div class="grid baguetteBoxThree gallery">
				<div class="element-item transition webdesign " data-category="post-transition">
					<a href="{{url('website/assets/img/gallery/emp-1.jpg')}}">
						<img src="{{url('website/assets/img/gallery/emp-1.jpg')}}" />
						<div class="hover-img">
				...
				<div class="element-item post-transition ecommerce " data-category="post-transition">
					<a href="{{url('website/assets/img/gallery/emp-2.jpg')}}">
						<img src="{{url('website/assets/img/gallery/emp-2.jpg')}}" />
						<div class="hover-img">
							<h2>E-commerce</h2>
							<i class="fa fa-camera camera"></i>
						</div>
				...
				<div class="element-item post-transition webdesign " data-category="post-transition">
					<a href="{{url('website/assets/img/gallery/emp-3.jpg')}}">
						<img src="{{url('website/assets/img/gallery/emp-3.jpg')}}" />
						<div class="hover-img">
							<h2>Website Design</h2>
							<i class="fa fa-camera camera"></i>
						</div>
				...
				<div class="element-item transition ecommerce " data-category="post-transition">
					<a href="{{url('website/assets/img/gallery/emp-4.jpg')}}">
						<img src="{{url('website/assets/img/gallery/emp-4.jpg')}}" />
						<div class="hover-img">
							<h2>E-commerce</h2>
							<i class="fa fa-camera camera"></i>
						</div>
				...
				<div class="element-item post-transition logo " data-category="post-transition">
					<a href="{{url('website/assets/img/gallery/emp-5.jpg')}}">
						<img src="{{url('website/assets/img/gallery/emp-5.jpg')}}" />
						<div class="hover-img">
							<h2>Logo</h2>
							<i class="fa fa-camera camera"></i>
						</div>
				...
				<div class="element-item post-transition cms " data-category="post-transition">
					<a href="{{url('website/assets/img/gallery/emp-6.jpg')}}">
						<img src="{{url('website/assets/img/gallery/emp-6.jpg')}}" />
						<div class="hover-img">
							<h2>CMS</h2>
							<i class="fa fa-camera camera"></i>
						</div>
				...
				<div class="element-item post-transition logo " data-category="post-transition">
					<a href="{{url('website/assets/img/gallery/emp-7.jpg')}}">
						<img src="{{url('website/assets/img/gallery/emp-7.jpg')}}" />
						<div class="hover-img">
							<h2>Logo</h2>
							<i class="fa fa-camera camera"></i>
						</div>
				...
				<div class="element-item transition cms " data-category="post-transition">
					<a href="{{url('website/assets/img/gallery/emp-8.jpg')}}">
						<img src="{{url('website/assets/img/gallery/emp-8.jpg')}}" />
						<div class="hover-img">
							<h2>CMS</h2>
							<i class="fa fa-camera camera"></i>
						</div>
				...
				<div class="element-item post-transition ecommerce " data-category="post-transition">
					<a href="{{url('website/assets/img/gallery/emp-9.jpg')}}">
						<img src="{{url('website/assets/img/gallery/emp-9.jpg')}}" />
						<div class="hover-img">
							<h2>E-commerce</h2>
							<i class="fa fa-camera camera"></i>
						</div>
				...
				<div class="element-item post-transition webdesign " data-category="post-transition">
					<a href="{{url('website/assets/img/gallery/emp-10.jpg')}}">
						<img src="{{url('website/assets/img/gallery/emp-10.jpg')}}" />
						<div class="hover-img">
							<h2>Web Design</h2>
							<i class="fa fa-camera camera"></i>
						</div>
				...
				<div class="element-item post-transition logo " data-category="post-transition">
					<a href="{{url('website/assets/img/gallery/emp-11.jpg')}}">
						<img src="{{url('website/assets/img/gallery/emp-11.jpg')}}" />
						<div class="hover-img">
							<h2>Logo</h2>
							<i class="fa fa-camera camera"></i>
						</div>
				...
				<div class="element-item transition cms " data-category="post-transition">
					<a href="{{url('website/assets/img/gallery/emp-12.jpg')}}">
						<img src="{{url('website/assets/img/gallery/emp-12.jpg')}}" />
						<div class="hover-img">
							<h2>CMS</h2>
							<i class="fa fa-camera camera"></i>
						</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-xs-12 col-sm-4 col-md-4 wow fadeInUp animated" data-wow-delay=".1s">
					<div class="blog-img">
						<img src="{{url('website/assets/img/blog1.JPG')}}" />
					</div>
					<div class="row">
				...
				<div class="col-xs-12 col-sm-4 col-md-4 wow bounceIn animated" data-wow-delay=".4s">
					<div class="blog-img">
						<img src="{{url('website/assets/img/blog2.JPG')}}" />
					</div>
					<div class="row">
						<div class="data">30</div>
						<div class="month">March</div>
				...
				<div class="col-xs-12 col-sm-4 col-md-4 wow fadeInDown animated" data-wow-delay=".3s">
					<div class="blog-img">
						<img src="{{url('website/assets/img/blog3.JPG')}}" />
					</div>
					<div class="row">
						<div class="data">30</div>
						<div class="month">March</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-6 col-md-6">
					...
					<p class="copyright">
						&copy; 2021 Creative Web. Created By <a href="http://www.creativeweb.com">Creative Web</a>
					</p>
				...
				<div data-wow-delay=".6s" class="col-xs-12 col-sm-6 col-md-6 wow bounceIn  animated"
					...
					<section class="widget widget_text" id="text-15">
						...
						<div class="textwidget">
							<p class='address'>
								786, Firs Avenue, The Mall,<br>
								Tel: 01 234-56786<br>
								Mobile: 01 234-56786<br>
								E-mail: <a href="#">info@creativeweb.com</a><br>
